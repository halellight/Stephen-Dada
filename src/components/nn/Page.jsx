      ...
      <div className={styles.container}>
        <FramerMagnetic>
          <svg
            ...
            height="50"
          >
            <path d="M28.06 0C21.09 0 18.09 3.66 17.07 7.87 19.07 5.43 21.05 4.23 23.97 4.23c3.84 0 5.9 2.1 6.67 6.3.84 4.8-1.92 11.45-8.36 19.96 4.57-1.03 7.9-3.7 10-8 1.57-3.33 1.28-7.43-.86-11.3C28.27 6.3 25.49 0 28.06 0zM10.03 13.35c-7.17 0-10.1 4.02-11.12 7.35 2.02-2.44 4.05-3.64 6.98-3.64 3.84 0 5.9 2.1 6.67 6.3.84 4.8-1.92 11.45-8.36 19.96 4.57-1.03 7.9-3.7 10-8 1.57-3.33 1.28-7.43-.86-11.3C10.24 19.65 7.46 13.35 10.03 13.35z" />
          </svg>
        </FramerMagnetic>
